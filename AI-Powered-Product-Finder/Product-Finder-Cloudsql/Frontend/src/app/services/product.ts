...
export class Product {
  ...
  private api = 'https://cloudsql-search-service-888916268766.asia-south1.run.app/list-products';

  private searchApi = 'https://cloudsql-search-service-888916268766.asia-south1.run.app/cloudsql/search';


  // New endpoints for categories and brands
  private listCategoriesApi = 'https://cloudsql-search-service-888916268766.asia-south1.run.app/list-categories';
  private listBrandsApi = 'https://cloudsql-search-service-888916268766.asia-south1.run.app/list-brands';
  ...
  searchMulti(types: string[], question: string, filters?: any): Observable<any> {
    ...
    return this.http.post<any>(this.searchApi, body);
  }
